...
import DeleteAccountFeedback from '../src/screens/DrawerScreens/DeleteAccountFeedback'
...
describe('DeleteAccount', () => {
    it('renders correctly', () => {
        ...
        const tree = renderer.create( <DeleteAccountFeedback {...mockedParams}  />).toJSON();
        expect(tree.type).toBe( 'View')
        const component = render( <DeleteAccountFeedback {...mockedParams} />);
